...
@Repository
public interface ExamenRepository extends PagingAndSortingRepository<ExamenEntity, Long>, ExamenRepositoryPersonalizado {
    ...
    ExamenEntity findByPostulante_Id(Long postulante_id);
