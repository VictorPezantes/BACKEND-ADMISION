...
public class PostulanteController {
    ...
    public ResponseEntity<?> registrarPostulante(@RequestParam(name = "curriculum") MultipartFile curriculum,
                                                 ...
                                                 @RequestParam(name = "fechaIngresoTrabajoReciente") @DateTimeFormat(pattern = "dd/MM/yyyy") Date fechaIngresoTrabajoReciente,
                                                 @RequestParam(name = "fechaSalidaTrabajoReciente") @DateTimeFormat(pattern = "dd/MM/yyyy") Date fechaSalidaTrabajoReciente,
